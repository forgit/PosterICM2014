...
{\bf Theorem 4. }{\it If $M(\lambda)=\widetilde M(\lambda)$, then $q(x)=\tilde q(x)$ a.e. for $x>0$. Thus, the Weyl function uniquely determines the boundary value problem $\cal L$. }
}
